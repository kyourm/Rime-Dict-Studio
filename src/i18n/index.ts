...
export const i18n = createI18n({
  ...
  messages: {
    "zh-CN": {
      ...
      editor: { eyebrow: "词条", search: "搜索词组或编码", add: "新增词条", phrase: "词组", code: "编码", weight: "权重", optional: "可选", edit: "编辑", cancel: "取消", confirmAdd: "加入词典", confirmEdit: "保存修改", entries: "条词条", loadMore: "已显示 {shown}/{total}，加载更多", save: "保存到词典", saving: "正在保存…", manualDeploy: "保存后请手动重新部署 Rime" },
